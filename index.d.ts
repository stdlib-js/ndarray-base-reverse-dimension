...
* // returns [ [ 5, 6 ], [ 3, 4 ], [ 1, 2 ] ]
*/
declare function reverseDimension<T = unknown>( x: genericndarray<T>, dim: number, writable: boolean ): genericndarray<T>;
...
* // returns [ [ 5, 6 ], [ 3, 4 ], [ 1, 2 ] ]
*/
declare function reverseDimension<T = unknown>( x: typedndarray<T>, dim: number, writable: boolean ): typedndarray<T>;
